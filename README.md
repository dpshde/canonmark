...
- **Daily**: one puzzle per day, same for everyone, seeded from the date. Emoji-grid share string.
...
| Daily | Epoch `2026-08-01` local = #1; seed `"canonmark#" + N` → xmur3 → mulberry32; weighted pool + 180 no-repeat window |
